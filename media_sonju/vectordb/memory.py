...
def summarize_old_messages(messages, llm, max_messages=4):
    """
...
def get_conversation_summary_memory(max_messages=10):
    """
...
def get_memory_config(memory_type="summary"):
    ...
    if memory_type == "summary":
        return {
            ...
            "description": "대화 요약 기반 메모리 (최근 10개 메시지 유지, 나머지는 요약)"
        }
    else:
