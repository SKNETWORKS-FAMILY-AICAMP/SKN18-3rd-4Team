...
def crawl_faq(main_cat, cddtlid, use_bracket=False):
    ...
    try:
        with sync_playwright() as p:
            ...
            # 저장 폴더 생성
            output_dir = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'skmagic_faq_data')
            ...
            for sub_i in range(sub_count):
                ...
                while True:
                    ...
                    for faq_i in range(faq_count):
                        try:
                            ...
                            full_text = text
                            if table_markdown:
                                full_text = f"{text} {table_markdown}".strip()
                ...
                if data:
                    ...
                    with open(filename, 'w', newline='', encoding='utf-8-sig') as f:
                        writer = csv.DictWriter(f, fieldnames=['sub_category', 'title', 'text', 'images'])
                        writer.writeheader()
